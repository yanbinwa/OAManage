...
.controller('EmployeeSignMobileTabCtrl', function($scope, $rootScope, $state, User, Employee, DateUtil, WebsocketClient, URL, ionicDatePicker) {
    
    $scope.$watch('$viewContentLoaded', function(event) {
		
	})
	
    $scope.$on("EmployeeSignMobileTabCtrl", function(event, msg) {
    ...
    $scope.$on('$stateChangeSuccess', function(event, toState, toParams, fromState, fromParams) {
    	var url = toState.url;
		if (URL.getCtrByUrl(url) == 'EmployeeSignMobileTabCtrl') {
			openTabResponse();
		}
	});
    ...
    var sendMsg = function(msg) {
		msg.routeKey = 'EmployeeSignMobileTabCtrl';
    ...
    $scope.getBrithdayStr = function() {
    	if ($scope.employee == null || $scope.employee.birthday == null)
    	{
    		return '';
    	}
    	return DateUtil.getDateStrFromTimestamp($scope.employee.birthday);
    }
