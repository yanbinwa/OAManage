...
.controller('UserStoreTabCtrl', function($scope, $rootScope, $state, $ionicPopup, WebsocketClient, UserInfo, DateUtil, URL) {
	...
	$scope.$on('$stateChangeSuccess', function(event, toState, toParams, fromState, fromParams) {
		var url = toState.url;
		if (URL.getCtrByUrl(url) == 'UserStoreTabCtrl') {
			openTabResponse();
		}
	})
	...
	$scope.$on("UserStoreTabCtrl", function(event, msg) {
		var functionKey = msg.functionKey;
